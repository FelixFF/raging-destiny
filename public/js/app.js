...
var slideWidth = slides.length > 0 ? slides[0].getBoundingClientRect().width : 0;
...
var hideShowNavigation = function hideShowNavigation(target, currentIndex) {
  if (currentIndex === 0) {
...
if (nextButton !== null && previousButton !== null) {
  ...
  dotsNav.addEventListener('click', function (e) {
    ...
    var currentSlide = track.querySelector('.current-slide');
    var currentDot = dotsNav.querySelector('.current-slide');
    var targetIndex = dotsChildren.findIndex(function (dot) {
